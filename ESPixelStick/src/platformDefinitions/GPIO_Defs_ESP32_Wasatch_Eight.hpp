#pragma once
/*
* GPIO_Defs_ESP32_Wasatch_Eight.hpp - Output Management class
* Board Added by Jon Chuchla
*
...
#define DEFAULT_RMT_3_GPIO      gpio_num_t::GPIO_NUM_15
#define DEFAULT_RMT_4_GPIO      gpio_num_t::GPIO_NUM_17
#define DEFAULT_RMT_5_GPIO      gpio_num_t::GPIO_NUM_5
#define DEFAULT_RMT_6_GPIO      gpio_num_t::GPIO_NUM_33
...
#define DEFAULT_ETH_CLK_MODE           eth_clock_mode_t::ETH_CLOCK_GPIO0_OUT  //changed from above per Jason Rasmusseen's WLED sample.
